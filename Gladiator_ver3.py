...
print("Du kommer ha tre olika vapen val, Gladius, Trident och Spear")
print("De olika vapen gör olika mycket skada och träffchansen skiljer sig.")

vapen_val = input("Vilket vapen vill du använda? Gladius, Trident eller Spear: ").lower()
